...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/apiresponse.MessageResponse"
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.ForgotPasswordDTO"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.RolePageResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/domain.RoleEntity"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.ReplacePermissionsRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.TenantPageResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/api/users": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.UserPageResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Campos para cadastrar novo usuário",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/users/{id}/tenant": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Tenant e role de destino",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.ChangeUserTenantRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "domain.ChangeUserTenantRequest": {
            "type": "object",
            "required": [
                "role_id",
                "tenant_id"
        ...
        "domain.RegisterRequest": {
            ...
            "properties": {
                "avatar_url": {
                    "type": "string",
                    "example": "https://github.com/antonio.silva/avatar.jpg"
                },
                "bio": {
                    "type": "string",
                    "example": "Minha bio"
                ...
                "email": {
                    "type": "string",
                    "example": "antonio.silva@email.com"
                },
                "job_title": {
                    "type": "string",
                ...
                "role_id": {
                    "type": "string",
                    "example": "216aaf06-34b6-3d26-8866-ad2f94babeea"
                }
            }
        },
        "domain.ReplacePermissionsRequest": {
            "type": "object",
            "properties": {
                "permission_ids": {
                    "type": "array",
