...
BEGIN
    ...
    ALTER TABLE roles ALTER COLUMN tenant_id SET DEFAULT default_tenant;
    ...
    ALTER TABLE refresh_tokens ALTER COLUMN tenant_id SET DEFAULT default_tenant;
    ...
    ALTER TABLE audit_logs ALTER COLUMN tenant_id SET DEFAULT default_tenant;
